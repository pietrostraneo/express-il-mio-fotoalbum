// Importing Styles
import styleEdit from './EditPhoto.module.scss'
...
export default function EditPhoto() {
    ...
    const { id } = useParams();  // Assumendo che l'ID della foto sia passato come parametro
    ...
    useEffect(() => {
        async function fetchPhoto() {
            try {
                const response = await axios.get(`${Api}/api/photos/${id}`);
                ...
                setCategorySelected(photoData.categories.map(c => c.id));
            } catch (error) {
                console.error(error);
            }
        }
    ...
    async function handleSubmit(e) {
        ...
        try {
            await axios.put(`${Api}/api/photos/${id}`, formData, {
                headers: {
            ...
            <div className="container">
                <div className="row mt-5 justify-content-center pb-5">
                    ...
                    <div className="col-md-8 col-12 mb-5 d-flex justify-content-between align-items-center">
                        <h1 className="fw-bold flex-wrap w-75">Edit the photo</h1>
                        <span className={`${styleEdit.buttons}`} onClick={handleBack} ><MdArrowBackIosNew /></span>
                    </div>
                    ...
                    <div className="col-12 col-md-8 text-center">
                        ...
                        <form onSubmit={handleSubmit} method="post">
                            ...
                            <div className="mb-3">
                                ...
                                {data.image && !preview && (
                                    <img src={`http://localhost:3000/uploads/photos/${data.image}`} alt="" className={`${styleEdit.img} mb-3`} />
                                )}

                                {preview && <img src={preview} alt='preview' className={`${styleEdit.img} mb-3`} />}
                            ...
                            <div className="mb-3">
                                ...
                                <textarea
                                    className={`${styleEdit.input} ${styleEdit.description_input}`}
                                    id="description"
                                    rows="10"
                            ...
                            <button type="submit" className="btn btn-outline-primary w-50">Update</button>
